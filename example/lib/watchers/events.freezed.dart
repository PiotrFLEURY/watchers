...
abstract class $EventsDataCopyWith<$Res> {
  ...
  $Res call({bool loading, int count});
}
...
class _$_EventsData implements _EventsData {
  const _$_EventsData({this.loading = false, this.count = 0});
  ...
  @override
  String toString() {
    return 'EventsData(loading: $loading, count: $count)';
  }
...
abstract class _EventsData implements EventsData {
  const factory _EventsData({final bool loading, final int count}) =
      _$_EventsData;
